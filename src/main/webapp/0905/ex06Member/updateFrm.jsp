	...
	<form action="#" method="post">
		<table border="1">
			<c:forEach var="item" items="${members }">
				<tr>
					<td>아이디</td>
					<td><input type="text" name="userId" value="${members.get(0).userId }" readonly /></td>
				</tr>
				<tr>
					<td>비밀번호</td>
					<td><input type="password" name="userPw" value="${item.userPw }"/></td>
				</tr>
				<tr>
					<td>이름</td>
				...
				<tr>
					<td>전화번호</td>
					<td><input type="tel" name="phoneNo" value="${item.phoneNo }"/></td>
				</tr>
				<tr>
					<td>주소</td>
